...
<div class="container white rounded z-depth-1" style="border-radius: 6px;">
    <div style="padding: 1em">
        <h5>Buscardor de Clientes<a class="btn btn-dark blue-grey right" href="index.php" class="right btn btn-info"><i class="icon-user-plus white-text"></i> Nuevo Cliente</a></h5>
        <hr>
