...
<div class="container white rounded z-depth-1" style="border-radius: 6px;">
    <div style="padding: 1em">
        <h5 class="alert alert-success"><img src="assets/icono_cliente.png" alt="" width="5%">Buscardor de Clientes (Garantia de Equipo)</h5>
        <hr>
            ...
            while ($resultado = $result4->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td><a href="nueva_garantia.php?indcliente=<?php echo $resultado['indcliente']; ?>"
                           class="btn btn-dark">Crear Garantia</a></td>
                </tr>
            <?php }
